...
public class SelfDuplicatorxxx {

    static int classname_lineno = 12;
    static String classname = "SelfDuplicatorxxx";
    static String nextclassname = classname+"x";

    static int filename_lineno = 16;
    static String filename = "C:/Users/Neelay/workspace/APCS/SmallProjects/src/selfduplicator/SelfDuplicatorxxx";
